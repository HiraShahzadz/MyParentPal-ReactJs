...
function Tags({ setTasktag }) {
  const [selectedTag, setSelectedTag] = useState(option[0]); // Initial selected status
    ...
    <Menu as="div" className="relative inline-block text-left">
      <div className="bg-white">
        <Menu.Button
          ...
          onChange={(event) => {
            setTasktag(selectedTag.label); // Update the status when the menu button is clicked
          }}
